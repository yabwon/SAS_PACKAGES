...
In this repository we are presenting the **SAS Packages Framework** which allows to develop and use SAS packages. The latest version of SPF is **`20260721`**.
...
--------------------------------------------------------------------------------------------
 ...
 Macro to install SAS packages, version `20260721`
...
-------------------------------------------------------------------------------
 ...
 Macro to get help about SAS packages, version `20260721`
...
-------------------------------------------------------------------------------
 ...
 Macro to *load* SAS packages, version `20260721`
...
-------------------------------------------------------------------------------
 ...
 Macro wrapper for the loadPackage macro, version `20260721`
...
-------------------------------------------------------------------------------
 ...
 Macro to unload SAS packages, version `20260721`
...
-----------------------------------------------------------------------------------------
 ...
 Macro to list available SAS packages, version `20260721`
...
-------------------------------------------------------------------------------
 ...
 Macro to verify SAS package with it hash digest, version `20260721`
...
-------------------------------------------------------------------------------
 ...
 Macro to get preview of a SAS packages, version `20260721`
...
-------------------------------------------------------------------------------
 ...
 Macro to generate SAS packages, version `20260721`
...
-----------------------------------------------------------------------------------------
 ...
 Macro to list directories pointed by 'packages' fileref, version `20260721`
...
-------------------------------------------------------------------------------
 ...
 Macro to load *additional content* for a SAS package, version `20260721`
...
--------------------------------------------------------------------------------------------
 ...
 Macro to request (install and load) SAS packages, version `20260721`
...
-------------------------------------------------------------------------------
 ...
 files with separate snippets, version `20260721`
...
-------------------------------------------------------------------------------
 ...
 Macro to *locally copy or move* (relocate) SAS packages, version `20260721`
...
-----------------------------------------------------------------------------------------
 ...
 Macro to check if the `packages` fileref is "correct", version `20260721`
...
-------------------------------------------------------------------------------
 ...
 Macro prints help notes for SAS Packages Framework macros, version `20260721`
...
-------------------------------------------------------------------------------
 ...
 Macro to *create bundles* of SAS packages, version `20260721`
...
-------------------------------------------------------------------------------
 ...
 Macro to *extract* SAS packages from a bundle, version `20260721`
